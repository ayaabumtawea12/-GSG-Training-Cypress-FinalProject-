...
const copyResultsToWatchFolder = (allureResults, allureResultsWatch) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    results.forEach(res => {
        ...
        (0, fs_tools_1.copyFileCp)(res, to, true, () => {
            doneFiles = doneFiles + 1;
        });
    });
    yield (0, fs_tools_1.waitWhileCondition)(() => doneFiles < results.length);
});
const allureTasks = (opts) => {
    ...
    return {
        ...
        testEnded: (arg) => __awaiter(void 0, void 0, void 0, function* () {
            ...
            yield allureReporter.endTest(arg);
            log('testEnded');
        }),
        label: (arg) => {
        ...
        endAll: () => __awaiter(void 0, void 0, void 0, function* () {
            log('endAll started');
            yield allureReporter.endAll();
            log('endAll');
        }),
        message: (arg) => {
        ...
        afterSpec(arg) {
            ...
            return __awaiter(this, void 0, void 0, function* () {
                ...
                if (arg.results && ((_a = arg.results) === null || _a === void 0 ? void 0 : _a.video)) {
                    ...
                    yield allureReporter.attachVideoToContainers({ path: video !== null && video !== void 0 ? video : '' });
                }
                else {
