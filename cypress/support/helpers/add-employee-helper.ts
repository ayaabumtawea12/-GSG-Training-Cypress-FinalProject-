    ...
    cy.log(`${jobTitleIds}`);
        ...
        return cy.AddEmployee("https://opensource-demo.orangehrmlive.com/web/index.php/api/v2/pim/employees", empPayload).then((response) => {
         //   const empNumber =response.body.data.empNumber; 
           ...
           cy.log(response.body.data.empNumber).as('employeeenumber');
           cy.log(locationIds).as('looocaaationn');
           cy.log(jobTitleIds).as('jop titleeeeeee')
           cy.request({
                method: 'PUT',
            ...
            cy.api({
             ...
             body:{
                   ...
                   // payFrequencyId: faker.number,
                    // payGradeId: faker.number,
